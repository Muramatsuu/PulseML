...
#[derive(Debug)]
pub struct PulseMLProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PulseMLProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PulseML processing");
    
    let mut processor = PulseMLProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PulseMLProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PulseMLProcessor::new(false);
